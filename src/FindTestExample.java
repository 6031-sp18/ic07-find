...
public class FindTestExample {
    ...
    // x:         neg, 0, pos
    // a.length:  0, 1, 2+
    // vals in a: neg, 0, pos; all same, increasing
    // i:         0, middle, n-1, -1
